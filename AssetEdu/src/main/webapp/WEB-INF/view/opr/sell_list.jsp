...
<!-- =================================================== -->
<title><c:out value="${pageTitle}" default="주식매도-리스트" /></title>
<style>
#frDate, #toDate {
    width :120px;
}
...
<main class="container mx-3 my-3">
    ...
    <h2><i class="fa-solid fa-cube my-3"></i> 주식매도 거래내역</h2>
    ...
    <div class="container-lg p-3 mb-3 border border-2 rounded-1">
        ...
        <a class="btn d-inline align-middle btn-success" href="/opr/sell_insert">  <i class="fa-solid fa-pencil-alt"></i> 매도등록</a>
    </div>
    ...
    <table class="table table-sm table-hover mt-3 contTable" style="font-size:small">
      <thead class="table-light">
        <tr class="text-center">
          ...
          <th scope="col" style="width:70px">제세금</th>
          <th scope="col" style="width:100px">결제금액</th>
          <th scope="col" style="width:90px">결제일자</th>
          <th scope="col" style="width:100px">매매처</th>
          <th scope="col" style="width:100px">매매손익</th>
      ...
      <tbody class="table-group-divider" >
        <c:forEach var="cont" items="${list}" varStatus="status">
            <tr class="align-middle">
              ...
              <td class="text-end"><fmt:formatNumber value="${cont.opr01Tax }"       pattern="#,###"/></td>
              ...
              <td class="text-end"><fmt:formatNumber value="${cont.opr01TrPl }"      pattern="#,###"/></td>
              <td>
...
$(document).ready(function () {
    ...
    $('.btnRetrieve').on('click', function(){
        ...
        AssetUtil.submitGet('/opr/sell_list', {frDate: frDate, toDate: toDate, searchText: searchText});
    });
    
    //초기화버튼 클릭
    $('.btnInit').on('click', function(){
        AssetUtil.submitGet('/opr/sell_list', {frDate: AssetUtil.today(), toDate: AssetUtil.today(), searchText: null});
    });
    
    //상세보기
    $('.btnDetail').on('click', function(){
        var contId = $(this).data('cont-id');
        AssetUtil.submitGet('/opr/sell_delete', {opr01ContId: contId});
    });
